  ...
  return (
    <div className="min-h-screen bg-slate-950">
      ...
      <nav className="bg-slate-900 border-b border-slate-800 sticky top-0 z-50">
        <div className="px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-8">
            ...
            <Link href="/prayer-times" className="text-slate-400 hover:text-white transition-colors">
              Prayer Time
            </Link>
            <Link href="/ramadan" className="text-white hover:text-white transition-colors font-medium">
              Ramadan 2026
            </Link>
          </div>
      ...
      <div className="absolute inset-0 opacity-10 pointer-events-none">
        <div className="absolute top-20 left-10 w-24 h-32 border-2 border-slate-600 rounded-b-lg"></div>
        <div className="absolute top-20 right-10 w-24 h-32 border-2 border-slate-600 rounded-b-lg"></div>
        <div className="absolute bottom-40 left-20 w-20 h-28 border-2 border-slate-600 rounded-b-lg"></div>
        <div className="absolute bottom-40 right-20 w-20 h-28 border-2 border-slate-600 rounded-b-lg"></div>
      </div>

      {/* Content */}
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-20 text-center">
        {/* Main Title */}
        <h1 className="text-6xl lg:text-7xl font-bold text-white mb-8 tracking-widest">
        ...
        <div className="mb-12">
          ...
          <p className="text-slate-400 text-lg">Dhu al-Qi'dah 15, 1447 AH</p>
        </div>

        {/* Countdown Section */}
        <div className="mb-16">
          <h2 className="text-2xl font-bold text-white mb-8">RAMADAN COUNTDOWN</h2>
          
          <div className="grid grid-cols-4 gap-4 max-w-2xl mx-auto mb-12">
            {/* Days */}
            <div className="bg-slate-900 border-2 border-green-600 rounded-lg p-6">
              <div className="text-5xl font-bold text-green-600 mb-2">
                {String(countdown.days).padStart(3, '0')}
              </div>
              <p className="text-slate-400 font-medium">Days</p>
            </div>
            ...
            <div className="bg-slate-900 border-2 border-green-600 rounded-lg p-6">
              ...
              <p className="text-slate-400 font-medium">Seconds</p>
            </div>
          </div>
        ...
        {/* Info Section */}
        <div className="bg-slate-900 rounded-lg border border-slate-800 p-8 text-left max-w-2xl mx-auto">
          <h3 className="text-2xl font-bold text-white mb-4">About Ramadan 2026</h3>
