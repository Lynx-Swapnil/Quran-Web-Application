      ...
      <div className="flex flex-1 overflow-hidden">
          ...
          <div className="p-4 border-b border-slate-200">
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-white border border-slate-200 rounded-lg pl-10 pr-3 py-2 text-slate-900 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-green-600"
              />
            </div>
          </div>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-slate-600">{s.arabicName}</p>
                    </div>
                  </div>
                </div>
              </Link>
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="bg-gradient-to-b from-slate-50 to-white border-b border-slate-200 px-8 py-6">
            ...
            <p className="text-slate-600">Ayah-{surah.totalAyahs}, {surah.revelation}</p>

            {/* Content Tabs */}
            <div className="flex gap-6 mt-6">
              <button className="text-slate-900 pb-2 border-b-2 border-green-600 font-medium">
                Translation
              </button>
              <button className="text-slate-600 hover:text-slate-900 pb-2 transition-colors">
                Reading
              </button>
            </div>
          </div>
